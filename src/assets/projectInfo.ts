  ...
  list: [
    ...
    },
    {
      ...
      detail: {
        ...
        whatIDid: [
          "메인페이지, 기부/봉사 목록 및 상세페이지, 마이페이지 제작을 담당하였습니다.",
    ...
    },
    {
      ...
      detail: {
        ...
        thumbnail: "",
        lowThumbnail: "",
        description: "조립하듯 쉽게 사용하고, 변경하는 UI 라이브러리",
        ...
        gitHub: "https://github.com/elast-ui-lab/elast-ui",
        link: "https://elast-ui.vercel.app/",
        tech: ["NPM", "Reactjs", "TypeScript"],
        whatIDid: [
          "프로젝트 기획 및 Git과 Jira를 이용하여 프로젝트 일정 관리",
          "Select, Combobox, Modal, Tabs 컴포넌트 구현",
          "Dataset을 활용하여 요소의 상태별 TailwindCSS 스타일링 구현",
          "키보드 방향키 조작을 위한 이벤트 객체 구현",
          "TabsWrapper 컴포넌트가 자식 요소를 알지 못해도, Tabs의 순서에 따라 콘텐츠가 보이도록 하기 위해 cloneElement로 Tabs.item에 onClick 이벤트를 추가해 재정의",
          "Combobox의 검색 기능 구현을 위해 React.Children 객체에서 자식 요소를 탐색하고 필터링",
          "합성 컴포넌트 패턴 UI를 통해 개발 생산성과 가독성 개선",
          "소개 페이지 제작 및 npm 배포",
        ],
      },
    },
